...
centerFoil = CenterFoil(vb,thetaL, 1.4, 0.1); % initialize center foil model passing AoA[degree] , span & chord[m]
...
x0 = [boat.SpeedRange(2), 2, mean(crew.range)];

disp('mean speed range');
disp(boat.SpeedRange(2));

% Lower and upper bounds for the variables
lb = [0, -5, crew.range(1)];
ub = [10, 5, crew.range(2)];
