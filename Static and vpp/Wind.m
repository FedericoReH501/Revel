classdef Wind
    ...
    methods
        ...
        function AWS = AWS(obj)
            ...
            AWS_ms = sqrt((TWS_ms * sin(TWA_rad))^2 + (TWS_ms * cos(TWA_rad) + vb)^2);  % Apparent wind speed in m/s
        ...
        function AWA = AWA(obj)
            ...
            AWA_rad = atan(TWS_ms * sin(TWA_rad) / (TWS_ms * cos(TWA_rad) + vb));  % Apparent Wind Angle in radians
